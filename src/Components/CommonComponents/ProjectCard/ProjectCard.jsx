import { RubyIcon, AwsIcon, NodeIcon, ReactIcon } from '@component/assets/projectIcon'
import ArrowCircleRightOutlinedIcon from '@mui/icons-material/ArrowCircleRightOutlined';
import { CircularProgress, Divider } from '@mui/material';
import Image from 'next/image'
import React, { useEffect, useState } from 'react'

function ProjectCard({ reverse, projectImageUrl, projectTitle, projectDescription, requestDemoOnClick }) {
            ...
            >
                ...
                <div className='project-card-right' >
                    ...
                    <div className='poject-framework-icons' >
                        ...
                        <Image width={50} src={AwsIcon} alt="AWS Amazon Web Service" />
                    </div>
