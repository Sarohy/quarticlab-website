    ...
    <div className={styles.AUCard2MainContain}>
      <div className={styles.AUCard2ImgContent}>
        ...
        <div className={styles.AUCard2ImgDetail}>
          ...
          <h2 className={styles.AUCard2ImgDSubHeading} ref={animatedTextRef[0]}>
            Our Mission
          </h2>
          ...
          <p className={styles.AUCard2ImgDText} ref={animatedTextRef[2]}>
            ...
            professionals takes immense pride in their ability to engineer your
            requirements into robust software solutions, harnessing the full
            potential of cutting-edge technologies spanning mobile, web, cloud,
            and e-commerce. We go beyond mere solutions; we are your strategic
            partner, committed to propelling your business forward in the
            digital landscape.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className={styles.AUCardDataContainer}>
          ...
          <p ref={animatedLeftDivRef[1]}>
            Our services are designed to be cost-effective without compromising
            on quality. We understand the importance of budget constraints, and
            our team works diligently to provide solutions that align with your
            financial resources. We strive to deliver excellent value for your
            investment, ensuring that you receive high-quality mobile app
            development services within your budget.
          </p>
          <h3
            className={styles.AUCardDataSubHeading}
          ...
          <p ref={animatedRightDivRef[2]}>
            ...
            address any concerns or queries you may have. Whether its technical
            assistance or general inquiries, our support team is committed to
            providing prompt and reliable assistance. We understand the
            importance of uninterrupted support, and our team is always ready to
            assist you, ensuring a smooth and hassle-free experience throughout
